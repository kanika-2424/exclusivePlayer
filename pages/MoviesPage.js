...
//     if (el) {
//     const container = qs(".search-category-name"); // Parent!
// const input = qs(".search-category-input");
// if (container && input) {
//   container.classList.add("focused"); // ✅ Correct!
//   input.blur();
// }
//        el.blur();
...
//     if (headerInput) {
//       headerInput.blur();
//       headerInput.classList.remove("focused");
//     }
//   }
...
//       } else {
//         // Second ENTER - deactivate and stay focused visually
//         isSearchInputActive = false;
//         input.blur();
//         input.classList.add("focused"); // Keep visual focus
//       }
//     }
//   } 
