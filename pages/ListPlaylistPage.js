...
//         if (localStorage.getItem("currentPage") !== "playlist" || modalOpen || isLoggingIn) {
//     console.log("❌ listPlaylistClick blocked - currentPage:", localStorage.getItem("currentPage"), "modalOpen:", modalOpen, "isLoggingIn:", isLoggingIn);
//     return;
//   }
...
//     isLoggingIn = true; // ADD THIS LINE - Set flag before login
...
//       } else {
//         isLoggingIn = false; // ADD THIS LINE - Reset on failure
...
//       }
//     } catch (error) {
//       isLoggingIn = false; // ADD THIS LINE - Reset on error
...
//     // Handle long press on Enter key
//     if ((e.key === "Enter" || e.keyCode === 13) && !enterPressTimer && focusIndex >= 0) {
//       enterPressTimer = setTimeout(() => {
//         // Long press detected - open remove modal
//         openModal();
...
//     enterPressTimer = null;
//       console.log("🖱️ About to call listPlaylistClick, modalOpen:", modalOpen, "isLoggingIn:", isLoggingIn);
...
function mountListPlaylistPage(playlistsData) {
  ...
  function keydownHandler(e) {
    ...
    if ((e.key === "Enter" || e.keyCode === 13) && !enterPressTimer) {
      enterPressTimer = setTimeout(() => {
        // Long press detected - open remove modal (only for cards)
        if (focusIndex >= 0) {
          openModal();
        }
        enterPressTimer = null;
