      ...
      if (window._aspectRatioWasUsed) {
        setTimeout(() => {
          ...
          if (window.liveTvPageState) {
            ...
            console.log("✅ Focus moved to play/pause button after fullscreen exit");
          }
