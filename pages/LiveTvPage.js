...
//             `.channel-card[data-stream-id="${channelToPlay.stream_id}"]`
//           );
//           if (selectedCard) {
...
const SimpleVideoPlayer = (streamId, streamUrl, logo, height, channelName) => {
  return `
    <div class="live-video-player-div" style="width: 100%; height: ${height}; position: relative; background: #000; display: block; overflow: visible;">
      <video 
        id="live-video-player" 
        class="video-js vjs-default-skin video-aspect-169" 
        controls 
        ...
        data-stream-id="${streamId}"
        poster="${logo}"
        style="width: 100% !important; height: 100% !important; display: block !important; position: relative !important; object-fit: contain !important;"
      >
        <source src="${streamUrl}" type="application/x-mpegURL">
      </video>
