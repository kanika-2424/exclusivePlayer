...
//   // Show video controls with auto-hide
// // Show video controls with auto-hide
// // Show video controls with auto-hide
// // Show video controls with auto-hide
...
//     playPauseBtn.style.transition = "opacity 0.3s";
//     playPauseBtn.style.opacity = "1";
//   }
  
//   if (aspectBtn) {
//     aspectBtn.style.display = "flex";
//     aspectBtn.style.transition = "opacity 0.3s";
//     aspectBtn.style.opacity = "1";
//   }
...
//   // Auto-hide after 3 seconds - ONLY stay visible if user is on the buttons themselves
//   videoControlsTimeout = setTimeout(() => {
//     if (!inPlayPauseBtn && !inAspectRatioBtn) {
//       hideVideoControls();
//     }
//   }, 3000);
// };
...
//   // Don't hide if user is actively interacting with controls
//   if (inPlayPauseBtn || inAspectRatioBtn) {
//     return;
//   }
...
//     e.stopPropagation();
//     togglePlayPause();
//     showVideoControls(); // Reset timer on interaction
//   });
...
//   // Don't show controls on pause - let user manually show them if needed
// });

// videoEl.addEventListener("play", () => {
//   if (playIcon) playIcon.className = "fa-solid fa-pause";
//   // Show controls briefly when video starts playing, then auto-hide
//   showVideoControls();
// });

//   videoEl.addEventListener("click", (e) => {
//     e.stopPropagation();
//     showVideoControls(); // Show and reset timer
//     togglePlayPause();
//   });
// }
...
//           playPauseBtn.style.opacity = "1";
//         }
//           showVideoControls(); // Keep controls visible
...
//           showVideoControls(); // Show controls when focusing aspect button
